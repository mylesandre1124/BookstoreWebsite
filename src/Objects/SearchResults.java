...
public class SearchResults {
    ...
    Collections.sort(Results, (Book b1, Book b2) -> b1.getCourse().compareTo(b2.getCourse()));
    }
    
    public void sortByProfessor(){
    Collections.sort(Results, (Book b1, Book b2) -> b1.getProfessor().compareTo(b2.getProfessor()));
    }
